...
import (
	"github.com/TheLinker/unipdf/v3/contentstream/draw"
	"github.com/TheLinker/unipdf/v3/model"
)
...
func (border *border) GeneratePageBlocks(ctx DrawContext) ([]*Block, DrawContext, error) {
	...
	if border.fillColor != nil {
		drawrect := draw.Rectangle{
			Opacity: 1.0,
			X:       border.x + border.borderWidthLeft/2,
			...
			Width:   border.width - border.borderWidthLeft/2 - border.borderWidthRight/2,
		}
